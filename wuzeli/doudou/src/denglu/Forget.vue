<template>
  <div class="outer">
    ...
    <div class="login-wrapper">
         ...
         <div class="container" >
        <h2  style="padding:10px;text-align:center">忘记密码</h2>
            <el-form :model="ruleForm" status-icon  label-width="50px" class="demo-ruleForm">
                ...
                <el-form-item style="text-align:center">
                    <el-button type="primary" @click="submitForm('ruleForm')" :disabled='disabled'>修改密码</el-button>
                </el-form-item>
            </el-form>
            <hr>
            <div style="margin-top:60px;text-align:center">
          <router-link to="login" id="a1">返回登陆</router-link>
        </div>
  ...
  export default {
    name:'login',
     ...
     methods: {
      ...
      computed:{
    exitsVal:function(){
        this.ifExist=Number(Boolean(this.ruleForm.admin))+Number(Boolean(this.ruleForm.pass));
    }
  },
  watch:{
