  ...
  <el-container >
    ...
    <el-main>
      ...
      <!-- markdown界面 -->
        ...
        <a >
          <i class="iconfont icon-fanhui"></i> 返回二级列表
        </a>
      </div>
      ...
      <tableWin3  v-if="visible" :level="level"  v-on:acceptValueT="acceptValueT" :path="path" :next="next" ></tableWin3>
...
import tableWin3 from "./tableWin3"
...
export default {
  ...
  data() {
    return {
     ...
     mdid:'',
      ...
      visible:true,
      content:'',  
      path:"http://localhost:3000/company3",
      next:'/details/level4/:name'
    }},
  components: {
    headbar: headbar,
    Sider: Sider,
  ...
  methods: {
   ...
   mounted(){
    ...
    console.log(this.level+"333333333333333333")
  }
    }
</script>
