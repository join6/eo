...
<template>
  <el-container >
    ...
    <el-main>
      ...
      <!-- markdown界面 -->
       <div class="btnbox" @click="back"  v-if="visible">
        <a >
          <i class="iconfont icon-fanhui"></i> 返回一级列表
        </a>
      </div>
    ...
    <tableWin2  v-if="visible"  :level="level" v-on:acceptValueT="acceptValueT" :path="path" :next="next" ></tableWin2>
...
import tableWin2 from "./tableWin2"
...
export default {
  ...
  data() {
    ...
    level:'',
      ...
      visible:true,
      content:'',  
      path:"http://localhost:3000/company2",
      next:'/details/level3/:name'
    }},
  components: {
    headbar: headbar,
    Sider: Sider,
